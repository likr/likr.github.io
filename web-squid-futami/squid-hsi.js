...
(function (squid) {
    var DataManager = (function () {
        ...
        DataManager.factorKey = function (v, t, d) {
...
(function (squid) {
    var SI = (function () {
        function SI(CPUEs, variableName_, timeIndex_, depthIndex_, lambda_) {
            this.CPUEs = CPUEs;
            this.variableName_ = variableName_;
            this.timeIndex_ = timeIndex_;
        ...
        Object.defineProperty(SI.prototype, "timeIndex", {
            get: function () {
        ...
        SI.prototype.interpolate = function () {
            var key = squid.DataManager.factorKey(this.variableName_, this.timeIndex_, this.depthIndex_);
    ...
    var SIManager = (function () {
        ...
        SIManager.prototype.createSI = function (variableName, timeIndex, depthIndex, lambda) {
            ...
            reader.onload = function (e) {
                ...
                var data = d3.csv.parse(e.target.result).map(function (d) {
                    ...
                    ['S', 'T', 'U', 'V', 'W'].forEach(function (v) {
                        ...
                        for (i = 0; i < 54; ++i) {
                            for (j = 0; j < 10; ++j) {
                                var key = squid.DataManager.factorKey(v, j, i);
...
(function (squid) {
    ...
    var CorrelationRenderer = (function () {
        ...
        CorrelationRenderer.prototype.draw = function (variableName, timeIndex, lambda) {
            var _this = this;
            var Rs = (function () {
                var Rs = [];
                var depth;
                for (depth = 0; depth <= maxDepth; ++depth) {
                    var key = squid.DataManager.factorKey(variableName, timeIndex, depth);
...
(function (squid) {
    function SITabController($scope, SIManager, CorrelationRenderer, DistributionRenderer, variableMapRenderer, SIMapRenderer) {
        ...
        $scope.saveSI = function () {
            ...
            $scope.currentSI = SIManager.createSI($scope.currentSI.variableName, $scope.currentSI.timeIndex, $scope.currentSI.depthIndex, $scope.currentSI.lambda);
        };
        ...
        distributionRenderer.draw(squid.DataManager.factorKey($scope.currentSI.variableName, $scope.currentSI.timeIndex, $scope.currentSI.depthIndex), $scope.currentSI.lambda);
        ...
        $scope.$watch('currentSI.timeIndex', function (newValue, oldValue) {
            if (newValue !== oldValue) {
                variableMapRenderer.drawVariable($scope.currentSI.variableName, $scope.currentSI.depthIndex);
                SIMapRenderer.drawSI($scope.currentSI);
                correlationRenderer.draw($scope.currentSI.variableName, $scope.currentSI.timeIndex, $scope.currentSI.lambda);
